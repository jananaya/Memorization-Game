...
let jugada = 0;
// Estas variables almacenaran el nombre de los personajes de las jugadas 1 y 2
let nombrePersonaje1 = '';
let nombrePersonaje2 = '';
// Esta variable almacenara las imagenes 1 y 2 para luego acceder a ella y modificar su src de ser necesario
let SelectorIMG1;
let SelectorIMG2;
let altIMG1;
let altIMG2;
...
function iniciar() 
{
  // altera las pocisiones del arreglo por unas completamente aleatorias
  personajes.sort(function() {return Math.random() - 0.5});
...
function clickImagen(imagen) 
{
  ...
  {
    // esto se ejecuta en la segunda jugada y captura en nombre de la segunda imagen y mira si es igual al de la primera
      altIMG2 = imagen.alt;
      SelectorIMG2 = imagen;
      nombrePersonaje2 = nombrePersonaje_Parametro2;
      const SonIguales = nombrePersonaje2 === nombrePersonaje1 && altIMG1 !== altIMG2;
